...
public class GuiNewMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public GuiNewMainMenu()
    {
        ...
        validSession = AccountSwitch.getInstance().getAuthHandler().validSession(mc.getSession());
    }
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(100, 5, 5, 100, 20, "Switch Accounts"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawString(this.fontRendererObj, display, 110, 10, color.getRGB());
